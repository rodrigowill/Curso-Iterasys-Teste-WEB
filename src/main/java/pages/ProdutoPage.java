...
public class ProdutoPage {
	...
	private By quantidade = By.id("quantity_wanted");
	...
	public void alterarQuantidade (int qtd) {
		driver.findElement(quantidade).clear();
		driver.findElement(quantidade).sendKeys(Integer.toString(qtd));
	}
	
	public ModalProdutoPage clicarAdicionarCarrinho() {

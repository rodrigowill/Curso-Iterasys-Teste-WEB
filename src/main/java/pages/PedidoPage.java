...
public class PedidoPage {
	...
	private By totalProdutos = By.cssSelector("div.col-sm-6 div.text-xs-right");
	...
	public Double obter_totalProdutos() {
		return Funcoes.removeCifraoRetornaDouble(driver.findElement(totalProdutos).getText());
	}
	
	public Double obter_totalTaxIncl() {
		return Funcoes.removeCifraoRetornaDouble(driver.findElement(totalTaxIncl).getText());
	}

...
public class HomePage {
	...
	private By nomeUsuarioLogado = By.cssSelector("#_desktop_user_info span");
	...
	public int obterQuantidadeProdutosNoCarrinho() {
		char qtdProdutosCarrinho = driver.findElement(textoprodutosNoCarrinho).getText().charAt(1);
		return qtdProdutosCarrinho - '0';
	}
	...
	public boolean estaLogado(String texto) {
		return texto.contentEquals(driver.findElement(nomeUsuarioLogado).getText());
	}

...
public class CheckoutPage {
	...
	private By botaoConfirmDeliveryOption = By.name("confirmDeliveryOption");
	...
	private By opcaoIAgree = By.id("conditions_to_approve[terms-and-conditions]");
	...
	public void clicarBotaoConfirmDeliveryOption() {
		driver.findElement(botaoConfirmDeliveryOption).click();
	}
	...
	public void marcarIAgree() {
		driver.findElement(opcaoIAgree).click();
	}
	
	public boolean estaSelecionadoIAgree() {
		return driver.findElement(opcaoIAgree).isSelected();
	}

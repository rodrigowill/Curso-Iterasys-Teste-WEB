...
public class ModalProdutoPage {
	...
	private By descriaoProduto = By.className("product-name");
	...
	private By incluirCarrinho = By.cssSelector("div.cart-content-btn a");
	...
	public String obterDescricaoProduto() {
		return driver.findElement(descriaoProduto).getText();
	}
	...
	public CarrinhoPage clicarIncluirCarrinho() {
		driver.findElement(incluirCarrinho).click();
